...
('1', '301', '1001', 'filename_1', 'So I''m fully comfortable with Monday to Thursday rhythm in Zurich and Fridays I''m back in Berlin. So I have done that for 2 years already and this kind of logistics is no problem for me and it''s a second nature, so I can easily deal with that. ', 0.0, NULL),
('2', '301', '1002', 'filename_2', 'Yeah, fully driven teams, , that practice radical transparency, so open dashboards, short, short feedback loops, and decision making that''s biased to action when everyone can speak up and data is shared in real time, I do my best work. ', 0.0, NULL),
('3', '301', '1003', 'filename_3', 'Yeah, during a code review, our CTO pointed out that my modules lacked test coverage, which slowed slowed  onboarding. So I re-engineered my workflow to write tests first and peer review documentation. Six months later, our onboarding time dropped by 40%. ', 0.0, NULL),
('4', '301', '1004', 'filename_4', 'Yeah, I''m that guy. I sketch a quick impact matrix for myself always and align on the good enough decision, then deliver an MVP within 24 hours. That''s mainly when I do it, what I do in such kind of situation and  that creates learning data and lets us  course correct without over engineering.', 0.0, NULL),
('5', '301', '1005', 'filename_5', 'Oh wow, yeah, so integrity and ownership if I commit, I deliver no hidden blockers. I try to escalate and risk early then surprise the team later so that''s really a personal value that is nonnegotiation for me. ', 0.0, NULL),
('6', '301', '1006', 'filename_6', 'Yeah, so once two engineers were talking debating a code style, I scheduled the 5 15 minute peer review session, facilitated the conversation, and we agreed on a for a matter that both adopted. Tension dissolved and velocity rebounded the next sprint. ', 0.0, NULL),
('7', '301', '1007', 'filename_7', 'The chance to scale a cross-border web tree product aligns perfectly with my career path. Building trust in decentralized tech between Germany and Switzerland markets is a mission I can wake up really excited  about about for years. ', 0.0, NULL),
('8', '301', '1008', 'filename_8', 'Yeah, I upskilled myself all the time, so I''m I really know which skills are very fundamental to me and I have newsletter that I read. I have some peers group where we talk  all the time about . About the new upcoming technologies and  so this is how I upskill myself. It''s mainly I don''t do a full degree like of advanced studies, but I really focus on on all the news and if there is something very new I really dig deep into that. , that''s how I. Keep it up to date. ', 0.0, NULL),
('9', '301', '1009', 'filename_9', 'I need a quiet workplace, and the best hours for me are from 100 a.m. to 4 p.m. central European time. And  I really like to have a communication tool where I get fast feedback from all the developers . Something like slack, for example. But this is mainly how, how I work very great and can make peak performance. And I always I also think when we when I write to to all the . Employees or other are writing to me that we expect from each other that we write back within the next 24 hours so that  that I can know, OK, I can let that . I can let that be for some time and can really focus on. On, on, on working on my. My Yeah, my delivers without getting distracted all the time. ', 0.0, NULL),
('10', '301', '1010', 'filename_10', 'So there''s nothing on the horizon. My resident permits cover Switzerland and my health is solid and my family fully supports the travel schedule, so should be everything fine.', 0.0, NULL)
